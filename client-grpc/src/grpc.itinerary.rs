        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn get_all_with_filter(
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/grpc.itinerary.RpcService/get_all_with_filter",
            );
        ...
        pub async fn get_by_id(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/grpc.itinerary.RpcService/get_by_id",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        pub async fn insert(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/grpc.itinerary.RpcService/insert",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
        /// Returns a [`tonic::Response`] containing a itinerary [`Response`](super::Response) object
        ...
        pub async fn update(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/grpc.itinerary.RpcService/update",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        pub async fn delete(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/grpc.itinerary.RpcService/delete",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        pub async fn search(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/grpc.itinerary.RpcService/search",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
    }
