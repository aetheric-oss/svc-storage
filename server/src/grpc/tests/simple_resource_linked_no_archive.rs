...
use crate::resources;
use crate::resources::test_util::simple_resource_linked_no_archive::*;
...
crate::impl_grpc_simple_service_linked!(simple_resource_linked_no_archive, simple_resource, linked);
