...
mod tests {
    ...
    fn test_vertiport_schema() {
        ...
        unit_test_info!("(test_vertiport_schema) start");
        ...
        unit_test_info!("(test_vertiport_success) start");
    }

    #[test]
    fn test_vertiport_invalid_data() {
        init_logger(&Config::try_from_env().unwrap_or_default());
        unit_test_info!("(test_vertiport_invalid_data) start");
        ...
        unit_test_info!("(test_vertiport_invalid_data) success");
    }
}
