...
impl fmt::Display for GeoPointZ {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        // no_coverage: It's impossible to get None, as GeoPointZ into PointZ will always add the default srid
...
impl fmt::Display for GeoPolygonZ {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        #[cfg(not(tarpaulin_include))]
        // no_coverage: It's impossible to get None, as GeoPolygonZ into PolygonZ will always add the default srid
